...
class OrderController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $totalOrders = Order::latest()->count();
        $totalAmount = Order::all()->sum('amount');
        $orders = Order::latest()->paginate(20);
        $total_wallet = User::select('wallet')->sum('wallet');
        ...
        return view('admin.orders.index',compact('orders','total_wallet','request','totalOrders','totalAmount'));
    }
