...
<ul class="navbar-nav">
  ...
  <li class="nav-item">
    <a class="nav-link {{ Request::is('user/rules*') ? 'active' : '' }}" href="{{ url('https://oprime.com.ng/wordpress/our-rules') }}">
      <i class="fi fi-rs-paper-plane"></i>
      <span class="nav-link-text">{{ __('Our Rulesn') }}</span>
    </a>
  </li>
 
    <li class="nav-item">
    <a class="nav-link {{ Request::is('user/logs*') ? 'active' : '' }}" href="{{ url('https://wa.me/2348169581573?text=hey') }}">
      <i class="fi fi-rs-paper-plane"></i>
