      ...
      <!-- <div class="row"> -->
         ...
         <div class="col-xl-12 col-md-6">
            ...
            <div class="card card-stats">
               <!-- Card body -->
               <div class="card-body">
               <center><a href="https://dashboard.oprime.com.ng/user/device"> <div class="alert alert-success" role="alert"><marquee>  😍 <b><font color="black">GMAIL GV #2,500, DOMAIN GV:#900, TALKATONE: #1,3000, TEXTNOW: NOT AVAILABLE, TWITTER 12 YEARS: #800, NETFLIX: #900, 
